				  ...
				  <div class="modal-content-resultats">
					...
					<div id="modalBoxContent" class="modal-bodyOtherTeam text-center">
						<div class="flex-container-modalProfil">
							<div class="columnProfil" v-for="team in loadedTeams"><img :src="'/images/teams/' + loadedTeams.slug + '.png'" class="imgModalFlags"/> <span class="modal-Team-Title" @>{{ loadedTeams.name }} <i class="fa fa-star" @click="selectTeam(team)"></i></span> <img :src="'/images/teams/' + loadedTeams.slug + '.png'" class="imgModalFlagsRight"/></div>
						</div>
