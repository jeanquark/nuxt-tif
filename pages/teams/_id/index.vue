                ...
                <div class="modal-content-resultats">
					...
					<div id="modalBoxContent" class="modal-bodyOtherTeam text-center">
                        <div class="flex-container-modalProfil">
                            <div class="columnProfil"><img :src="'/images/teams/' + team.image" class="imgModalFlags"/> <span class="modal-Team-Title">{{ loadedTeam.name }}</span> <img :src="'/images/teams/' + team.image" class="imgModalFlagsRight"/></div>
                        </div>
