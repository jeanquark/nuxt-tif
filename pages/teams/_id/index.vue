				  ...
				  <div class="modal-content-resultats">
					...
					<div id="modalBoxContent" class="modal-bodyOtherTeam text-center">
						<div class="flex-container-modalProfil">
							<div class="columnProfil" v-for="team in loadedTeamsByCompetition"><img :src="'/images/teams/' + team.image" class="imgModalFlags"/> <span class="modal-Team-Title">{{ loadedCompetition.category.name }}</br>{{ loadedCompetition.name }}</br>{{ loadedCompetition.countries.name }}</span> <img src="images/flags/25.png" class="imgModalFlagsRight"/></div>
						</div>
