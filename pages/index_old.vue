        ...
        <section id="about">  
            ...
            <div class="row section-intro">
                <div class="col-twelve">
                    ...
                    <h1 style="font-size: 3rem;">{{ $t('pages.index.what_is_TIF_title') }}</h1>
                    <h1 style="font-size: 2rem;">{{ $t('pages.user-avatar.your_avatar') }}</h1>
                    ...
                    <div class="intro-info">
                        ...
                        <p class="lead" style="font-size: 1rem;">{{ $t('pages.index.what_is_TIF_text') }}</p>
                    </div>              
            ...
            <div class="row button-section">
                <div class="col-twelve">
					<button type="submit" class="button btn-facebook" @click.prevent="signInWithFacebook" :disabled="loading" style="font-size: 1rem;"><i class="fa fa-facebook"></i> {{ $t('pages.login.facebook_oauth') }}</button>
