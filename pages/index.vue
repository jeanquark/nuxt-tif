    ...
    <div id="top" ref="fullpage">
        ...
        <section id="intro" style="">   
            ...
            <ul class="intro-language">
              <li><nuxt-ling to="#"><img src="/images/flags/63.png" class="flagsLanguage"/></nuxt-link></li>
              <li><nuxt-ling to="#"><img src="/images/flags/145.png" class="flagsLanguage"/></nuxt-link></li>
              <li><nuxt-ling to="#"><img src="/images/flags/89.png" class="flagsLanguage"/></nuxt-link></li>
            </ul>
