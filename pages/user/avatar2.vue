    ...
    <div class="container-fluid">
        ...
        <div id="modalBox">
            <div class="modal-dialog modal-lg">
                ...
                <!-- Modal body -->
                <div id="modalBoxContent" class="modal-body container">

                    <div class="text-center">
                        <h1 style="color: #000;">Create your avatar</h1>
                        <p style="color: #000;">
                        ...
                        <div class="row" style="color: #000;" v-cloak>
                            <div class="col-2" style="">
                                ...
                                <div class="text-center" :class="{active: this.gender === 'female'}" style="cursor: pointer;" @click="selectGender('female')"><span class="">{{ $t('pages.user-avatar.female') }}</span></div>
                            ...
                            <div class="col-6" style="color: #000; text-align: center;"><img src="" ref="mergedImage" class="text-center" style="border: 1px solid darkred; border-radius: 5px;" width="90%" /></div>
